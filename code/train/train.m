%------------------------------------------------
%------------------------------------------------
% training code for the ProxField paper
...
if ~isdeployed
   ...
   addpath(genpath('stochastic_grad'));
end
...
Training.use_quantized_input = false; % set as false for denoise comparison with certain previous methods
...
%Training.fn_trainingdata = '../../data/dataset5_CSF_discrete_denoise_5_5_25/dataset5_CSF_discrete_denoise_5_5_25.mat'; 
%Training.N =  5; % number of images used at training
Training.fn_trainingdata = '../../data/dataset400_CSF_discrete_denoise_5_5_25/dataset400_CSF_discrete_denoise_5_5_25.mat'; 
